...
var _indexHeaderView = require("./views/index-header-view");
var _indexHeaderViewDefault = parcelHelpers.interopDefault(_indexHeaderView);
 ...
 */ class IndexPage extends (0, _baseViewDefault.default) {
    /** @type {IndexHeaderView} Хэдер */ indexHeaderView;
    /** @type {MovieListView} Список фильмов */ movieListView;
    #movies;
    constructor(...args){
        super(...args);
        // Получаем все фильмы из модели
        this.#movies = (0, _movieModelDefault.default).getAll();
    }
    ...
    /** Рендерит главную страницу */ render() {
        super.render();
        // Создаём View хэдера
        this.indexHeaderView = new (0, _indexHeaderViewDefault.default)("#page-header");
        this.indexHeaderView.render();
        // Создаём View для списка фильмов
        this.movieListView = new (0, _movieListViewDefault.default)("#movie-list-container", this.#movies);
...
},{"./views/movie-list-view":"dGia5","./models/movie-model":"kLR6K","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/index-header-view":"93iIV","./views/base-view":"b07nk"}],"dGia5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./base-view":"b07nk","./movie-modal-view":"gXOIY","../models/movie-model":"kLR6K","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"gXOIY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
                ...
                <section class="movie-modal-body">
                    ...
                    <div class="movie-modal-content">
                        ...
                        <menu>
                            ...
                            <a class="primary-btn" href="watch.html?movie_id=${encodeURIComponent(this._data.id)}">\u{421}\u{43C}\u{43E}\u{442}\u{440}\u{435}\u{442}\u{44C} \u{432}\u{43C}\u{435}\u{441}\u{442}\u{435} \u{2192}</a>
                        </menu>
                    </div>
                </section>
            </div>
...
},{"./base-view":"b07nk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"93iIV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _baseViewJs = require("./base-view.js");
var _baseViewJsDefault = parcelHelpers.interopDefault(_baseViewJs);
class IndexHeaderView extends (0, _baseViewJsDefault.default) {
    /** Метод для рендера HTML (обязательный для BaseView) */ _createInnerHTML() {
        return `<h1 class="truncate">\u{41A}\u{430}\u{442}\u{430}\u{43B}\u{43E}\u{433} \u{444}\u{438}\u{43B}\u{44C}\u{43C}\u{43E}\u{432}</h1>`;
    }
}
exports.default = IndexHeaderView;

},{"./base-view.js":"b07nk","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["2aZ6o","8JWvp"], "8JWvp", "parcelRequireae0c", {})
